...
from .app.authentik import AuthentikCallbackEndpoint, AuthentikOauthInitiateEndpoint
...
from .space.authentik import AuthentikCallbackSpaceEndpoint, AuthentikOauthInitiateSpaceEndpoint
