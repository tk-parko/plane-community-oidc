...
const errorCodeMessages: {
  ...
  [EAuthenticationErrorCodes.GITHUB_USER_NOT_IN_ORG]: {
    title: `Not a member of the organization`,
    message: () => `You are not a member of the required GitHub organization.`,
  },
  [EAuthenticationErrorCodes.AUTHENTIK_NOT_CONFIGURED]: {
    title: `Authentik not configured`,
    message: () => `Authentik not configured. Please contact your administrator.`,
  },
  [EAuthenticationErrorCodes.AUTHENTIK_OAUTH_PROVIDER_ERROR]: {
    title: `Authentik OAuth provider error`,
    message: () => `Authentik OAuth provider error. Please try again.`,
  },
