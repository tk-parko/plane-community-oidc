...
authentik_config_variables = [
    {
        "key": "IS_AUTHENTIK_ENABLED",
        "value": os.environ.get("IS_AUTHENTIK_ENABLED", "0"),
        "category": "AUTHENTIK",
        "is_encrypted": False,
    },
    {
        "key": "AUTHENTIK_HOST",
        "value": os.environ.get("AUTHENTIK_HOST"),
        "category": "AUTHENTIK",
        "is_encrypted": False,
    },
    {
        "key": "AUTHENTIK_APP_NAME",
        "value": os.environ.get("AUTHENTIK_APP_NAME"),
        "category": "AUTHENTIK",
        "is_encrypted": False,
    },
    {
        "key": "AUTHENTIK_CLIENT_ID",
        "value": os.environ.get("AUTHENTIK_CLIENT_ID"),
        "category": "AUTHENTIK",
        "is_encrypted": False,
    },
    {
        "key": "AUTHENTIK_CLIENT_SECRET",
        "value": os.environ.get("AUTHENTIK_CLIENT_SECRET"),
        "category": "AUTHENTIK",
        "is_encrypted": True,
    },
    {
        "key": "ENABLE_AUTHENTIK_SYNC",
        "value": os.environ.get("ENABLE_AUTHENTIK_SYNC", "0"),
        "category": "AUTHENTIK",
        "is_encrypted": False,
    },
]
