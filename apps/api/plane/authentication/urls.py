...
from .views import (
    ...
    AuthentikCallbackEndpoint,
    AuthentikOauthInitiateEndpoint,
    AuthentikCallbackSpaceEndpoint,
    AuthentikOauthInitiateSpaceEndpoint,
)
...
urlpatterns = [
    ...
    ## Authentik Oauth
    path("authentik/", AuthentikOauthInitiateEndpoint.as_view(), name="authentik-initiate"),
    path("authentik/callback/", AuthentikCallbackEndpoint.as_view(), name="authentik-callback"),
    path(
        "spaces/authentik/",
        AuthentikOauthInitiateSpaceEndpoint.as_view(),
        name="space-authentik-initiate",
    ),
    path(
        "spaces/authentik/callback/",
        AuthentikCallbackSpaceEndpoint.as_view(),
        name="space-authentik-callback",
    ),
]
