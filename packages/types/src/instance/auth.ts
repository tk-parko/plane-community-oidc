...
export type TInstanceAuthentikAuthenticationConfigurationKeys =
  | "AUTHENTIK_HOST"
  | "AUTHENTIK_APP_NAME"
  | "AUTHENTIK_CLIENT_ID"
  | "AUTHENTIK_CLIENT_SECRET"
  | "ENABLE_AUTHENTIK_SYNC";
...
export type TInstanceAuthenticationConfigurationKeys =
  ...
  | TInstanceAuthentikAuthenticationConfigurationKeys;
...
export type TCoreLoginMediums = "email" | "magic-code" | "github" | "gitlab" | "google" | "gitea" | "authentik";
