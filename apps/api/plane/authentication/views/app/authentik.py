...
class AuthentikOauthInitiateEndpoint(View):
...
class AuthentikCallbackEndpoint(View):
    def get(self, request):
        ...
        try:
            provider = AuthentikOAuthProvider(request=request, code=code, callback=post_user_auth_workflow)
