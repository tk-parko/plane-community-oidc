...
import { AuthentikConfiguration } from "@/components/authentication/authentik-config";
...
export const getCoreAuthenticationModesMap: (
  ...
  authentik: {
    key: "authentik",
    name: "Authentik",
    description: "Allow members to log in or sign up to plane with their Authentik accounts.",
    icon: <img src={authentikLogo} height={20} width={20} alt="Authentik Logo" />,
    config: <AuthentikConfiguration disabled={disabled} updateConfig={updateConfig} />,
    enabledConfigKey: "IS_AUTHENTIK_ENABLED",
  },
});
